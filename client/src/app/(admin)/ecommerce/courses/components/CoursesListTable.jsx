...
const CoursesListTable = ({ courses }) => {
  const { deleteCourse } = useGlobalContext() // ✅ hook inside component
    ...
    },
    {
      ...
      cell: ({
        ...
        <div className="d-flex gap-2">
          <Link to={`/ecommerce/courses/edit/${_id}`} className="btn btn-sm btn-soft-secondary" title="Edit Course">
            <IconifyIcon icon="bx:edit" className="fs-18" />
          </Link>
          <button type="button" className="btn btn-sm btn-soft-danger" title="Delete Course" onClick={() => handleDelete(_id)}>
